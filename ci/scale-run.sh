...
$OVNSUDO docker exec ovn-rally rally task results $TASKID --out /root/create-networks-data.json
...
$OVNSUDO docker exec ovn-rally rally task results $TASKID --out /root/create-and-list-lports-data.json
...
$OVNSUDO docker exec ovn-rally rally task results $TASKID --out /root/create-and-list-acls-data.json
...
$OVNSUDO docker exec ovn-rally rally task results $TASKID --out /root/create-and-bind-ports-data.json
