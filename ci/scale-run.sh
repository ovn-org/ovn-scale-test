...
$OVNSUDO docker exec ovn-rally rally test results $TASKID > /root/create-networks-data.json
...
$OVNSUDO docker exec ovn-rally rally test results $TASKID > /root/create-and-list-lports-data.json
...
$OVNSUDO docker exec ovn-rally rally test results $TASKID > /root/create-and-list-acls-data.json
...
$OVNSUDO docker exec ovn-rally rally test results $TASKID > /root/create-and-bind-ports-data.json
